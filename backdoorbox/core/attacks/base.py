...
from torchvision.datasets import DatasetFolder, MNIST, CIFAR10, GTSRB, SVHN
    ...
    def train(self, schedule=None):
        ...
        for i in range(self.current_schedule['epochs']):
            ...
            for batch_id, batch in enumerate(train_loader):
                ...
                targets_onehot = torch.nn.functional.one_hot(batch_label).float()
                loss = self.loss(predict_digits, targets_onehot)
                loss.backward()
                optimizer.step()
