...
class trainer:
    def __init__(self):
        ...
        self.net = baseline_MNIST_network.BaselineMNISTNetwork()
        model_dir_badnets = '../backdoorbox/experiments/BaselineMNISTNetwork_MNIST_BadNets_pos15_size10/ckpt_epoch_40.pth'
