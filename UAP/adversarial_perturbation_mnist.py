...
def generate(trainset, testset, net, delta=0.2, max_iter_uni=np.inf, xi=10, p=np.inf, num_classes=10, overshoot=0.2, max_iter_df=20, target_label=0):
    '''
    ...
    v=torch.zeros([1, 28, 28]).to(device)
